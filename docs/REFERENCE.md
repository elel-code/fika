...
- 右侧主栏采用 Dolphin 风格的横向列优先 compact 视图，支持轻量虚拟化
...
- Right main pane with Dolphin-style horizontal column-first compact view and lightweight virtualization
...
### 4.3 虚拟化主栏视图 / Virtualized Main Item View
