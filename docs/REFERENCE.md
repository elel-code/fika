...
├── file_tile.slint     # 主栏文件项显示、选择、右键菜单、双击打开
...
- 读取端：解析 `x-special/gnome-copied-files`、`text/uri-list`、`application/x-kde-cutselection`
...
- Read side: parses `x-special/gnome-copied-files`, `text/uri-list`, `application/x-kde-cutselection`
