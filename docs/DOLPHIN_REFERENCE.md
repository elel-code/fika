...
- Transfer operation menus and chooser filter/choice popups now use `TransferMenuLayer`, `ChooserOptionPopupLayer`, and `ChooserChoicePopupLayer`, keeping repeated popup shell, fixed sizing, coordinate conversion, and anchored positioning out of `AppWindow`.
