...
- [x] Drag external folder into Places.
  ...
  - Current: winit fallback source/mime constants, disable-env parsing, and startup diagnostics now live in `src/app/dnd.rs`; `main.rs` only handles the actual winit event bridge.
