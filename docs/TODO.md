...
- [~] Phase 0：新增独立 `fika-wgpu` spike，不删除 GPUI binary。当前已能打开独立
  ...
  item Cut 和 Paste 会拒绝 remote paths；Open With chooser/default-app selection、Open in New Pane、多 MIME `text/uri-list` clipboard export/import 等
