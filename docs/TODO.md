...
- [x] Dolphin-style context menu hover polish.
  ...
  - Current: file item, sidebar Places, Devices, Places blank-area, and main viewport context menus own their `PopupSurface` framing in `ui/menus.slint`, reducing repeated popup wrapper layout in `ui/app.slint`.
