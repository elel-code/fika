...
- [~] Spike Dolphin-style self-managed main viewport.
  ...
  - Next: 继续把剩余 Slint overlay 下沉到 renderer：先评估文字 raster 所需的字体/text stack，再收敛 title/metadata 绘制。
