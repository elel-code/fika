...
- [ ] Add split view / dual-pane browsing.
  ...
  - Current: ordinary copy/move/link completion status also uses the affected pane-id route, so async operation messages do not jump to the pane focused at completion time.
