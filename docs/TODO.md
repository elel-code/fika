...
- [~] Spike Dolphin-style self-managed main viewport.
  ...
  - Current: folder/file fallback media sidecars now update as sparse row models instead of pretending to be continuous virtual-range models, avoiding avoidable remove/insert churn when a mixed directory scroll shifts past items of the other kind.
