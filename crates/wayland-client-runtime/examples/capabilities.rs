...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "xdg_dialog_v1={} xdg_activation_v1={} xdg_toplevel_icon_v1={} text_input_v3={} pointer_constraints_v1={} relative_pointer_v1={} popup_reposition={} ext_background_effect={} fractional_scale={} cursor_shape={}",
