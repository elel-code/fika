...
use ui::item_view::{
    ItemViewScrollState, ItemViewScrollViewSnapshot, projected_item_viewport_width_for_pane_width,
...
impl FikaApp {
    ...
    fn sync_pane_view_from_item_view_scroll_handle(&mut self, pane_id: PaneId) -> bool {
        ...
        self.item_view_scroll
            .sync_view_from_handle_snapshot(pane_id, view, |sync| {
    ...
    fn sync_pane_view_from_authoritative_item_view_scroll_handle(
        ...
        let panes = &mut self.panes;
        self.item_view_scroll
            .sync_view_from_authoritative_handle_snapshot(pane_id, view, |sync| {
                let _ = panes.set_view_scroll(
                    pane_id,
                    sync.scroll_x,
                    sync.scroll_y,
    ...
    pub(crate) fn drop_place_drag_to_directory(
        &mut self,
        target_pane: PaneId,
        source_path: PathBuf,
        target_dir: PathBuf,
    ...
    pub(crate) fn drop_place_drag_to_place(
        ...
        let Some(source_path) = self
            ...
            self.clear_place_drop_target();
            self.set_pane_status(status_pane, "No active place drag");
            return;
        };
        self.dismiss_context_menu();
    ...
    fn set_pane_viewport_bounds(
        ...
        let scroll_changed = self
            .item_view_scroll
            .sync_view_after_bounds_update_snapshot(pane_id, view_snapshot, |sync| {
                let _ = panes.set_view_scroll(
                    pane_id,
                    sync.scroll_x,
                    sync.scroll_y,
