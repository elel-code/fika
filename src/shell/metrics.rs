...
pub(crate) const VISIBLE_ICON_SYNC_BUDGET: Duration = Duration::from_millis(200);
...
pub(crate) const ZOOM_STEP_MIN: i32 = -3;
pub(crate) const ZOOM_STEP_MAX: i32 = 4;
pub(crate) const ZOOM_STEP_SCALE: f32 = 0.12;
