...
pub(crate) const DND_PREVIEW_ICON_OUTLINE: f32 = 30.0;
pub(crate) const DND_PREVIEW_LABEL_MIN_WIDTH: f32 = 128.0;
pub(crate) const DND_PREVIEW_LABEL_HEIGHT: f32 = 36.0;
