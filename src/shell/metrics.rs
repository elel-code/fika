...
pub(crate) const DOLPHIN_ICONS_TEXT_WIDTH_INDEX: f32 = 1.0;
pub(crate) const DOLPHIN_ICONS_MAX_TEXT_LINES: usize = 3;
...
pub(crate) const DOLPHIN_FOLDER_PREVIEW_MAX_IMAGES: usize = 4;
pub(crate) const DOLPHIN_FOLDER_PREVIEW_SCAN_LIMIT: usize = 500;
...
pub(crate) const PATH_TRANSITION_ANIMATION_DURATION: Duration = Duration::from_millis(200);
pub(crate) const PATH_TRANSITION_ANIMATION_FRAME: Duration = Duration::from_millis(16);
pub(crate) const PATH_TRANSITION_APPEAR_DELAY: Duration = Duration::from_millis(100);
pub(crate) const PATH_TRANSITION_ENTER_SCALE: f32 = 0.8;
pub(crate) const PATH_TRANSITION_ENTER_OPACITY: f32 = 0.0;
