...
pub(crate) use icon_roles::{
    DOLPHIN_ICON_SIZE_UPDATE_DELAY, DOLPHIN_VISIBLE_ICON_SYNC_BUDGET, PaneIconRoleSizeState,
};
...
pub(crate) use perf::{
    ...
    ItemViewPerfPhase, StaticItemVisualPerfStats, classify_item_view_perf_phase,
};
