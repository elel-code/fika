...
pub(crate) struct AppState {
    ...
    pub(crate) clipboard_refresh_pending: Option<u64>,
    ...
    pub(crate) active_operation_pane_ids: Vec<u64>,
    pub(crate) pending_transfer_conflict: Option<TransferConflict>,
    pub(crate) last_undo: Option<FileUndo>,
    pub(crate) last_undo_serial: Option<u64>,
    pub(crate) active_undo_serial: Option<u64>,
    pub(crate) next_undo_serial: u64,
...
impl AppState {
    pub(crate) fn new(current_dir: PathBuf, places: Vec<PlaceEntry>) -> Self {
        Self {
            ...
            clipboard_refresh_pending: None,
            ...
            active_operation_pane_ids: Vec::new(),
            pending_transfer_conflict: None,
            last_undo: None,
            last_undo_serial: None,
            active_undo_serial: None,
            next_undo_serial: 1,
